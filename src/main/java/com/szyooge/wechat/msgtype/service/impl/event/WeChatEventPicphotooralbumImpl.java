...
@Service(WeChatXmlConst.IEvent.pic_photo_or_album)
public class WeChatEventPicphotooralbumImpl implements WeChatMsgTypeService {
    
    private static Logger logger = LoggerFactory.getLogger(WeChatEventPicphotooralbumImpl.class);
