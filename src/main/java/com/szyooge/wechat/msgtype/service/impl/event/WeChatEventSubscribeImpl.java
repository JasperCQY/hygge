...
@Service(WeChatXmlConst.IEvent.subscribe)
public class WeChatEventSubscribeImpl implements WeChatMsgTypeService {
    
    private static Logger logger = LoggerFactory.getLogger(WeChatEventSubscribeImpl.class);
