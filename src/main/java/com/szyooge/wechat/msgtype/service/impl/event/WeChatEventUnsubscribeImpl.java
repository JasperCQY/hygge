...
@Service(WeChatXmlConst.IEvent.unsubscribe)
public class WeChatEventUnsubscribeImpl implements WeChatMsgTypeService {
    
    private static Logger logger = LoggerFactory.getLogger(WeChatEventUnsubscribeImpl.class);
