...
@Service(WeChatXmlConst.IEvent.scancode_push)
public class WeChatEventScancodepushImpl implements WeChatMsgTypeService {
    
    private static Logger logger = LoggerFactory.getLogger(WeChatEventScancodepushImpl.class);
