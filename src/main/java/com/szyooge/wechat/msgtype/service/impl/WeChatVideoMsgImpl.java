...
@Service(WeChatXmlConst.IMsgType.video)
public class WeChatVideoMsgImpl implements WeChatMsgTypeService {
    
    private static Logger logger = LoggerFactory.getLogger(WeChatVideoMsgImpl.class);
    ...
    public String msg(Map<String, String> wxMap) {
        ...
        Resource resource = new ClassPathResource("replyXml/video.xml");
        InputStream in = null;
        try {
