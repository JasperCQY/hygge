...
@Service(WeChatXmlConst.IEvent.pic_sysphoto)
public class WeChatEventPicsysphotoImpl implements WeChatMsgTypeService {
    
    private static Logger logger = LoggerFactory.getLogger(WeChatEventPicsysphotoImpl.class);
