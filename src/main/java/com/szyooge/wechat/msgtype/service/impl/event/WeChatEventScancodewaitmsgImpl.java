...
@Service(WeChatXmlConst.IEvent.scancode_waitmsg)
public class WeChatEventScancodewaitmsgImpl implements WeChatMsgTypeService {
    
    private static Logger logger = LoggerFactory.getLogger(WeChatEventScancodewaitmsgImpl.class);
