...
@Service(WeChatXmlConst.IEvent.SCAN)
public class WeChatEventSCANImpl implements WeChatMsgTypeService {
    
    private static Logger logger = LoggerFactory.getLogger(WeChatEventSCANImpl.class);
