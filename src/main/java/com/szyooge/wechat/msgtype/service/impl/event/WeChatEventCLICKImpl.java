...
/**
 * 点击自定义菜单
 * @ClassName: WeChatEventCLICKImpl
 * @author quanyou.chen
 * @date: 2017年7月28日 上午11:16:12
 * @version  v 1.0
 */
@Service(WeChatXmlConst.IEvent.CLICK)
public class WeChatEventCLICKImpl implements WeChatMsgTypeService {
    
    private static Logger logger = LoggerFactory.getLogger(WeChatEventCLICKImpl.class);
