...
@Service(WeChatXmlConst.IMsgType.image)
public class WeChatImageMsgImpl implements WeChatMsgTypeService {
    
    private static Logger logger = LoggerFactory.getLogger(WeChatImageMsgImpl.class);
    ...
    public String msg(Map<String, String> wxMap) {
        ...
        Resource resource = new ClassPathResource("replyXml/image.xml");
        InputStream in = null;
        try {
