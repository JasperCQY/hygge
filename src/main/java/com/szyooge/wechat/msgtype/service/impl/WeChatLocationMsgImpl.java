...
@Service(WeChatXmlConst.IMsgType.location)
public class WeChatLocationMsgImpl implements WeChatMsgTypeService {
    
    private static Logger logger = LoggerFactory.getLogger(WeChatLocationMsgImpl.class);
