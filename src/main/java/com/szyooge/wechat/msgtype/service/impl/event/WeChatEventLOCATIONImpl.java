...
/**
 * 每5秒上报一次地理位置事件
 * @ClassName: WeChatEventLOCATIONImpl
 * @author quanyou.chen
 * @date: 2017年7月28日 上午11:16:33
 * @version  v 1.0
 */
@Service(WeChatXmlConst.IEvent.LOCATION)
public class WeChatEventLOCATIONImpl implements WeChatMsgTypeService {
    
    private static Logger logger = LoggerFactory.getLogger(WeChatEventLOCATIONImpl.class);
